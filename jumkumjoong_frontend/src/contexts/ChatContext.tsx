...
interface ChatContextType {
  ...
  lastReceivedMessages: Record<number, WebSocketMessage>;
...
const ChatProvider: React.FC<ChatProviderProps> = ({ children }) => {
  ...
  const [lastReceivedMessages, setLastReceivedMessages] = useState<Record<number, WebSocketMessage>>({});
